...
const config = {
  ...
  scene: [Precargas, Creditos, Derrota, Ayuda, Menu, Parte1, Transicion1, Transicion2, Transicion3, Transicion4, Transicion5, Obstaculo1, Obstaculo2, Obstaculo3, VictoriaJuego, Parte2, Parte3],
};
