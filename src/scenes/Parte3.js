export default class Parte3 extends Phaser.Scene {
  ...
  create() {
    ...
    //obstaculo
    this.obstaculoTres = this.physics.add.group({allowGravity: false});
    this.time.addEvent ({
      delay: 30000, 
      callback: this.obstaculoTercero, 
      callbackScope: this, 
      loop: false,
    });
    ...
    this.physics.add.overlap(this.tren, this.obstaculoTres, this.textoObstaculo, null, this);
  }
  ...
  update() {
    ...
    if (this.cursors.right.isDown) {
      ...
      //velocidad monedas 
      this.grupoMoneda.setVelocityX(-150);
      this.grupoBomba.setVelocityX(-170);
      this.obstaculoTres.setVelocityX(-100);
      ...
      this.obstaculoTres.setVelocityX(-0);
    }    
  ...
  obstaculoTercero() {
    if (this.cursors.right.isDown) {
      let obstaculo = this.obstaculoTres.create(820, 475, "obstaculo3"); 
    }
  }
